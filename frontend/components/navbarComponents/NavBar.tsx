    ...
    <>
      <div className="flex items-center justify-between h-[10vh] mx-auto max-w-[100vw]">
        <nav className="w-full">
          <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col justify-center items-center absolute left-0">
              ...
              <p className="text-jblue font-semibold text-xs mb-2 pl-3 md:pl-0 pb-4">
            ...
            <div className="flex items-center gap-6 mr-1 md:mr-5 ml-auto">
              ...
              <div className="hidden lg:flex md:justify-end md:gap-12">
                {pathsForNav.map((element: pathObj, index: number) => (
                  <div
                    className={`flex items-center justify-center h-[4vh] p-2 ${
                      element.href === path
                        ? "border-l-2 border-r-2 border-jblue"
                ...
                >
                  <Link
                    ...
                    href="#Quote"
                    onClick={handleClickForQuote}
                  >
                    <FileQuestion /> Request a Quote
                  </Link>
                </div>
              </div>
        ...
        <div
          ...
          className={`fixed z-20 bg-white overflow-hidden flex flex-col lg:hidden gap-12 top-0 right-0 ${
            !toggleMenu
              ? "h-0 w-full"
              : "h-auto flex-shrink-0 w-2/5 mt-4  border-l-4 border-b-4 border-jblue"
          }`}
        >
          <div className="mt-4 px-8">
            <div className="flex flex-col items-end justify-end text-end gap-8 font-bold tracking-wider">
              <button
              ...
              {pathsForNav.map((element: pathObj, index: number) => (
                <a className="mb-2" key={index} href={element.href}>
                  {element.text}
                </a>
              ))}
              ...
              <div className="flex flex-row justify-end items-center mb-2">
                <FileQuestion />
                <span className="ml-2" onClick={handleClickForQuote}>
                  Request a Quote
                </span>
              </div>
            </div>
        ...
        {getQuoteClicked && <QuoteForm setShowQuote={setGetQuoteClicked} />}
      </div>
    </>
  );
};
