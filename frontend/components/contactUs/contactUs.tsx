    ...
    return (
        <div className="text-jblue border-t-4 border-jblue flex flex-col md:flex-row items-center justify-center">
          <div className="flex flex-row font-semibold md:mr-4">
            <a className="flex flex-row mt-2 mb-2 md:mb-0 mt-0"  href="tel:+12628359400"><PhoneCallIcon/> Phone: 262-835-9400</a>
          </div>
          <div className="flex flex-row font-semibold md:mr-4">
          <a className="flex flex-row mb-2 md:mb-0" href="mailto:info@javco.co?subject=Javco Inquiry"><Mail/> Email: info@javco.co</a>
          </div>
          <div className="flex flex-row font-semibold">
            <a className="flex flex-row mb-2 text-center md:mb-0"
