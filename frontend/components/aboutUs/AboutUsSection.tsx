  ...
  return (
    <section className="bg-gray-100 p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex justify-center items-center mb-4">
          <Image height={400} width={500} src={salesLot.src} alt="Original Sales lot of Javco that shows the start of the business and its small beginnings" />
        </div>
        ...
        <div className="flex justify-center items-center mb-4">
          <Image height={400} width={500} src={Memorial.src} alt="The founders Avner and John looking dapper in suits later in life after starting a successful business" />
        </div>
      </div>
    </section>
  );
