        ...
        {textWithinResponse && currentTab === "Home" && (
          <div className="p-2 mt-2 ">
            ...
            <div className="flex flex-col">
              ...
              <textarea
                className="p-1"
                {...register("text.Home_Page.Main_Header", { required: true })}
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                placeholder={textWithinResponse.text.Home_Page.Info_About_Javco}
              />
            </div>
            <div className="flex flex-col mt-2 w-full">
              ...
              <div className="flex flex-wrap justify-between">
                <div className="flex flex-col">
                  ...
                  <input
                    className="w-1/2"
                    {...register("text.Home_Page.Types_Of_Trailers.Type_One", {
                      required: true,
                    })}
                    defaultValue={
                ...
                <div className="flex flex-col">
                  ...
                  <input
                    className="w-1/2"
                    {...register("text.Home_Page.Types_Of_Trailers.Type_Two", {
                      required: true,
                    })}
                    defaultValue={
                      textWithinResponse.text.Home_Page.Types_Of_Trailers
                ...
                <div className="flex flex-col">
                  <label className="text-sm text-jblue mr-2">Type Three:</label>
                  <input
                    className="w-1/2"
                    {...register(
                ...
                <div className="flex flex-col">
                  <label className="text-sm text-jblue mr-2">Type Four:</label>
                  <input
                    className="w-1/2"
                    {...register("text.Home_Page.Types_Of_Trailers.Type_Four", {
                      required: true,
                    })}
                    defaultValue={
                      textWithinResponse.text.Home_Page.Types_Of_Trailers
          ...
          <div>
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                defaultValue={textWithinResponse.text.Rentals_Page.Main_Header}
